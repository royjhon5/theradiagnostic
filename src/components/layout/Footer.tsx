...
const links = [
  ...
  {
    group: "Your Health, Our Priority",
    items: [
      {
      ...
      {
        title: (
          <Button className="bg-[#16A7E2] rounded-xl mt-5 cursor-pointer">
      ...
      <div className="mx-auto">
              ...
              <div key={index} className="text-[#116BB4] space-y-2 text-xs">
                ...
                {link.items.map((item, index) => (
                  <Link
                    key={index}
                    href={item.href}
                    className="text-[#116BB4] hover:text-blue-600 block duration-150"
                  >
        ...
        <div className="p-3 bg-[#16A7E2] flex flex-wrap items-end justify-evenly gap-6 py-6">
          ...
          <div className="text-white block text-center text-sm">
            © {new Date().getFullYear()} Designed & Powered by RePoint Solution
            Inc.
          </div>
