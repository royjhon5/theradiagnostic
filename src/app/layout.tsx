...
export const metadata: Metadata = {
  ...
  robots: "index, follow",
  keywords: ["diagnostics", "thera", "doctors appointment"],
  openGraph: {
    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        <link
          ...
          type="image/png"
          sizes="32x32"
          href="https://theradiagnostic-staging.vercel.app/favicon/favicon-32x32.png"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="96x96"
          href="https://theradiagnostic-staging.vercel.app/favicon/favicon-96x96.png"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href="https://theradiagnostic-staging.vercel.app/favicon-16x16.png"
        />
        <link
          rel="icon"
          type="image/x-icon"
        ...
        <link
          ...
          sizes="180x180"
          href="https://theradiagnostic-staging.vercel.app/favicon/apple-touch-icon.png"
        />
